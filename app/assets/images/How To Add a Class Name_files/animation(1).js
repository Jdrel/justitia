...
function animate(){
    ...
    TweenLite.to("#graphic",1, {delay:delay, y:0, x:0, scale:1.1, ease:Expo.easeOut});
    
    delay += .5;
    TweenLite.to("#visual",5, {delay:delay, y:0, x:10, scale:1.1, ease:Expo.easeInOut});
...
function reset() {
    ...
    TweenLite.set("#cta", {transformOrigin: "80px 45px"});
    TweenLite.set("#cta_hover", {transformOrigin: "80px 45px"});
    TweenLite.set("#visual", {x:140, scale:1.5});
    TweenLite.set("#paper_tear", {x:340});
    TweenLite.set("#graphic", {x:340, scale:.5});
